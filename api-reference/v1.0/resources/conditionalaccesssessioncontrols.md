...
|continuousAccessEvaluation|[continuousAccessEvaluationSessionControl](continuousAccessEvaluationSessionControl.md)| Session control to define the Continuous Access Evaluation behavior.|
